...
class Config:
    ...
    patience = 50                              # Number of epochs after which early stopping is triggered
    ...
    validation_frequency = 1                   ## frequency (in number of epochs) with which validation metrics are calculated
